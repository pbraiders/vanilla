...
function ContactAdd( $sLogin, $sSession, $sInet, &$pContact)
{
        ...
        && CDb::GetInstance()->IsOpen()===TRUE )
    {
        ...
        {
            // Prepare
            $pPDOStatement = CDb::GetInstance()->PDO()->prepare('CALL sp_ContactSet(:sLogin,:sSession,:sInet,:sLastName,:sFirstName,:sTel,:sEmail,:sAddress,:sAddressMore,:sCity,:sZip,:sComment)');
            // Bind
