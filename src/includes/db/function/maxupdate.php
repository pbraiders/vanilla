...
/**
  * function: MaxUpdate
  * description: Update max rent per month
  * parameters: STRING|sLogin     - login identifier
  *             STRING|sSession   - session identifier
  *             STRING|sInet      - concatenation of IP and USER_AGENT
  *              ARRAY|$tMonthMax - max rent per month
  ...
  */
function MaxUpdate( $sLogin, $sSession, $sInet, &$tMonthMax)
{
    $iReturn=-1;
    $sMessage='';
        ...
        && CDb::GetInstance()->IsOpen()===TRUE )
    {
        ...
        try
        {
            ...
            {
                // Prepare
                $pPDOStatement = CDb::GetInstance()->PDO()->prepare('CALL sp_ConfigUpdate( :sLogin, :sSession, :sInet, :sName, :sValue)');
                // Bind
                ...
                $pPDOStatement->bindParam(':sName',$key,PDO::PARAM_STR,45);
           	    $pPDOStatement->bindParam(':sValue',$value,PDO::PARAM_STR,255);
                // Execute
