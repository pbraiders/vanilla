...
/**
  ...
  *            INTEGER|iIdentifier - rent identifier
  ...
  */
function RentDel( $sLogin, $sSession, $sInet, $iIdentifier)
{
    $iReturn=-1;
    $sMessage='';
        ...
        && CDb::GetInstance()->IsOpen()===TRUE )
    {
        ...
        {
            // Prepare
            $pPDOStatement = CDb::GetInstance()->PDO()->prepare('CALL sp_RentDel(:sLogin,:sSession,:sInet,:iIdentifier)');
            // Bind
