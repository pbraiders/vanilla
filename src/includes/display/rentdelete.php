 ...
 *************************************************************************/
if ( !defined('PBR_VERSION') || !defined('PBR_URL') || !defined('PBR_AUTH_LOADED') || !isset($sToken) || !isset($pContact) || !isset($pDate) || !isset($pRent) || !isset($pHeader) )
    die('-1');
...
<ul>
<li class="listbuttonitem"><input class="inputButton" type="submit" value="Supprimer" name="con"<?php echo $pHeader->GetCloseTag(); ?>&nbsp;<input class="inputButton" type="submit" value="Annuler" name="can"<?php echo $pHeader->GetCloseTag(); ?></li>
</ul>
</fieldset>
</form>
</div>
