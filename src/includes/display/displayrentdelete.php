 ...
 *************************************************************************/
if ( !defined('PBR_VERSION') || !defined('PBR_URL') || !defined('PBR_CONTACT_LOADED') || !defined('PBR_RENT_LOADED') || !defined('PBR_DATE_LOADED') )
    die('-1');
...
?>
 <div id="PAGE">
  ...
  <div id="CONTENT">
   ...
   <form id="FORMCONFIRM" method="get" action="<?php echo PBR_URL;?>rentdelete.php">
